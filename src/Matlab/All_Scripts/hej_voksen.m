...
inlet = 90;                         % nederste kant
outlet = 219;                       % nederste kant
yref = 65;                          % upper corner of inlet
edge_thres = 0.285;                  % threshold for extracting channel edge
se_edge = strel('rectangle',[2 30]);% se for extracting channel edge
