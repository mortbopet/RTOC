...
void Machinelearning::predictObject(DataContainer& dataContainer, double decisionBoundary) {}
...
void LogisticRegression::predictObject(DataContainer& dataContainer, double decisionBoundary) {
